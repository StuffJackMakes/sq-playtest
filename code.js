...
function resetGame() {
    ...
    if (userConfirmed) {
        ...
        gameState.discard = [];
        gameState.deck = gameState.deck.concat(Object.keys(gameState.inPlay));
        gameState.inPlay = {};
        for (const playerId in gameState.players) {
            gameState.deck = gameState.deck.concat(gameState.players[playerId].hand);
            gameState.players[playerId].hand = [];
            gameState.deck = gameState.deck.concat(gameState.players[playerId].claimed);
